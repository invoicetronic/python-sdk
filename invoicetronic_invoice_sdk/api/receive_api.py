...
class ReceiveApi:
    ...
    def invoice_v1_receive_get(
        ...
        _param = self._invoice_v1_receive_get_serialize(
    ...
    def _invoice_v1_receive_get_serialize(
        self,
        company_id,
        identifier,
        unread,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/invoice/v1/receive',
    ...
    def invoice_v1_receive_id_delete(
        ...
        _param = self._invoice_v1_receive_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _invoice_v1_receive_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/invoice/v1/receive/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def invoice_v1_receive_id_get(
        ...
        _param = self._invoice_v1_receive_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _invoice_v1_receive_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
