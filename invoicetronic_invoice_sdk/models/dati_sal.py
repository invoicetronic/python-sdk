...
class DatiSAL(BaseModel):
    """
    DatiSAL
    """ # noqa: E501
    riferimento_fase: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["riferimento_fase"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "riferimento_fase": obj.get("riferimento_fase")
        })
        return _obj
