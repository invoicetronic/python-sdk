...
class Contatti(BaseModel):
    ...
    Contatti
    """ # noqa: E501
    telefono: Optional[StrictStr] = None
    fax: Optional[StrictStr] = None
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["telefono", "fax", "email"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if telefono (nullable) is None
        # and model_fields_set contains the field
        if self.telefono is None and "telefono" in self.model_fields_set:
            _dict['telefono'] = None
