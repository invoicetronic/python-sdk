...
class Event(BaseModel):
    ...
    request_body: Optional[StrictStr] = Field(default=None, description="Request payload. It is guaranteed to be cyphered at rest.")
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "version", "company_id", "method", "query", "endpoint", "api_version", "status_code", "date_time", "error", "request_body", "response_body", "success", "user_id", "api_key_id"]
