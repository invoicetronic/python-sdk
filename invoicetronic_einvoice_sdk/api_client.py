...
from invoicetronic_einvoice_sdk.api_response import ApiResponse, T as ApiResponseT
import invoicetronic_einvoice_sdk.models
from invoicetronic_einvoice_sdk import rest
from invoicetronic_einvoice_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(invoicetronic_einvoice_sdk.models, klass)
