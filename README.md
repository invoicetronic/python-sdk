...
*CompanyApi* | [**company_vat_get**](docs/CompanyApi.md#company_vat_get) | **GET** /company/{vat} | Get a company by vat number
*ExportApi* | [**export_get**](docs/ExportApi.md#export_get) | **GET** /export | Export invoices as a ZIP archive
...
*ReceiveApi* | [**receive_id_payload_get**](docs/ReceiveApi.md#receive_id_payload_get) | **GET** /receive/{id}/payload | Get a receive invoice payload by id
...
*SendApi* | [**send_id_payload_get**](docs/SendApi.md#send_id_payload_get) | **GET** /send/{id}/payload | Get a send invoice payload by id
...
*SubkeyApi* | [**subkey_get**](docs/SubkeyApi.md#subkey_get) | **GET** /subkey | List restricted keys
*SubkeyApi* | [**subkey_id_delete**](docs/SubkeyApi.md#subkey_id_delete) | **DELETE** /subkey/{id} | Delete a restricted key
*SubkeyApi* | [**subkey_id_get**](docs/SubkeyApi.md#subkey_id_get) | **GET** /subkey/{id} | Get a restricted key by id
*SubkeyApi* | [**subkey_id_roll_post**](docs/SubkeyApi.md#subkey_id_roll_post) | **POST** /subkey/{id}/roll | Roll the secrets of a restricted key
*SubkeyApi* | [**subkey_post**](docs/SubkeyApi.md#subkey_post) | **POST** /subkey | Add a restricted key
*SubkeyApi* | [**subkey_put**](docs/SubkeyApi.md#subkey_put) | **PUT** /subkey | Update a restricted key
...
## Documentation For Models
 ...
 - [SubKey](docs/SubKey.md)
 - [SubKeyRequest](docs/SubKeyRequest.md)
 - [SubKeyUpdate](docs/SubKeyUpdate.md)
 - [SubKeyWithSecrets](docs/SubKeyWithSecrets.md)
