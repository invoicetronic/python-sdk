# Python SDK for the Italian Invoicetronic API
...
*SendApi* | [**send_validate_files_post**](docs/SendApi.md#send_validate_files_post) | **POST** /send/validate/files | Validate an invoice by file
