...
class SendApi:
    ...
    def send_file_post(
        ...
        :type signature: str
        :param idempotency_key: Optional client-generated key that makes the submission idempotent. Retrying the same request with the same key within 24 hours returns the original response instead of creating a duplicate invoice. A replayed response carries the `Idempotent-Replayed: true` header.
    ...
    def send_get(
        ...
        latest_state: Annotated[Optional[StrictStr], Field(description="Filter by the most recent SDI state for the invoice. Matches the `latest_state` field exposed inline on each Send.")] = None,
        include_payload: Annotated[Optional[StrictBool], Field(description="Include payload in the response. Defaults to false.")] = None,
        ids: Annotated[Optional[StrictStr], Field(description="Comma-separated list of Send ids (max 100). Filters the collection to the matching rows; unknown or unauthorized ids are silently skipped.")] = None,
        ...
        :param latest_state: Filter by the most recent SDI state for the invoice. Matches the `latest_state` field exposed inline on each Send.
        :type latest_state: str
        :param include_payload: Include payload in the response. Defaults to false.
        :type include_payload: bool
        :param ids: Comma-separated list of Send ids (max 100). Filters the collection to the matching rows; unknown or unauthorized ids are silently skipped.
        :type ids: str
    ...
    def _send_get_serialize(
        ...
        if latest_state is not None:
            ...
            _query_params.append(('latest_state', latest_state))
    ...
    def send_id_payload_get(
        ...
        _param = self._send_id_payload_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def send_id_payload_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Item id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_id_payload_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Item id")],
        _request_timeout: Union[
            None,
    ...
    def _send_id_payload_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
