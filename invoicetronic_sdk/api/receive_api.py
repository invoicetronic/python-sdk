...
class ReceiveApi:
    ...
    def receive_id_payload_get(
        ...
        _param = self._receive_id_payload_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def receive_id_payload_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Item id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def receive_id_payload_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Item id")],
        _request_timeout: Union[
            None,
    ...
    def _receive_id_payload_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/receive/{id}/payload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
