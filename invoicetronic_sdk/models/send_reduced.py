...
class SendReduced(BaseModel):
    ...
    latest_state: Optional[StrictStr] = Field(default=None, description="Current SDI state of the invoice. Reflects the most recent update received from SDI.")
    __properties: ClassVar[List[str]] = ["identifier", "prestatore", "meta_data", "documents", "date_sent", "latest_state"]
