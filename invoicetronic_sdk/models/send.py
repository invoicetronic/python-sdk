...
class Send(BaseModel):
    ...
    company_id: Optional[StrictInt] = Field(default=None, description="Company id. It is set automatically based on the VAT number extracted from the invoice payload (the sender for `send`, the recipient for `receive`).")
    ...
    file_name: Optional[StrictStr] = Field(default=None, description="Xml file name. If not provided on send, it will be auto-generated.")
    ...
    latest_state: Optional[StrictStr] = Field(default=None, description="Current SDI state of the invoice. Reflects the most recent update received from SDI. Null when no update has been received yet.")
    company: Optional[Company] = None
    __properties: ClassVar[List[str]] = ["id", "created", "version", "user_id", "company_id", "committente", "prestatore", "identifier", "file_name", "format", "payload", "last_update", "date_sent", "documents", "encoding", "nome_committente", "meta_data", "latest_state", "company"]
    ...
    def latest_state_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if latest_state (nullable) is None
        # and model_fields_set contains the field
        if self.latest_state is None and "latest_state" in self.model_fields_set:
            _dict['latest_state'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "latest_state": obj.get("latest_state"),
