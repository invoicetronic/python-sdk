...
class Event(BaseModel):
    ...
    user_agent: Optional[Annotated[str, Field(strict=True, max_length=512)]] = Field(default=None, description="User-Agent header from the HTTP request.")
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "version", "user_id", "api_key_id", "company_id", "method", "endpoint", "api_version", "status_code", "date_time", "error", "resource_id", "user_agent", "success", "query", "response_body"]
